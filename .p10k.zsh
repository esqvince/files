# Generated by Powerlevel10k configuration wizard on 2025-05-19 at 11:07 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=135
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%33F'   # blue foreground
      local   modified='%112F'  # green foreground
      local  untracked='%214F'  # yellow foreground
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=112
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=148
  ...
  #######[ scalaenv: scala version from scalaenv (https://github.com/scalaenv/scalaenv) ]#######
  # Scala color.
  typeset -g POWERLEVEL9K_SCALAENV_FOREGROUND=203
